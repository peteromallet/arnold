...
- runtime candidate: `/workspace/runtime-candidates/native-build-forward-c2-a8baedf1-20260903-r7`
- chain session: `native-build-forward-c2-a8baedf1-20260903-r7`
- supported marker directory: `/workspace/.megaplan/cloud-sessions`; expected marker filename: `native-build-forward-c2-a8baedf1-20260903-r7.json`
- chain spec: `.megaplan/initiatives/native-build-forward-continuation-20260903-r7/chain.yaml`
...
under the r2 namespace; they are not deleted, imported, or replayed by r7.
...
immutable and are not reused by r7.
...
no r5 marker, chain state, owner, or provider receipt was created, and r7
...
historical evidence and are not reused by r7.
...
4. confirm the new chain has no persisted state and starts at C2, while the
   ...
   next action supported: `uv run python -m arnold_pipelines.megaplan cloud chain .megaplan/initiatives/native-build-forward-continuation-20260903-r7/chain.yaml --cloud-yaml .megaplan/initiatives/native-build-forward-continuation-20260903-r7/cloud.yaml`.
