...
Canonical source is `main@12870c88e84425b843d023620c50e51db049bb9e`.
...
- runtime candidate: `/workspace/runtime-candidates/native-build-forward-c2-bb000694-20260903-r4`
- chain session: `native-build-forward-c2-bb000694-20260903-r4`
- supported marker directory: `/workspace/.megaplan/cloud-sessions`; expected marker filename: `native-build-forward-c2-bb000694-20260903-r4.json`
- chain spec: `.megaplan/initiatives/native-build-forward-continuation-20260902-r4/chain.yaml`
...
2. verify that the chain driver's content-addressed revision pin
   (`12870c88e84425b843d023620c50e51db049bb9e`) and the remote checkout agree,
...
4. confirm the new chain has no persisted state and starts at C2, while the
   ...
   next action supported: `uv run python -m arnold_pipelines.megaplan cloud chain .megaplan/initiatives/native-build-forward-continuation-20260902-r4/chain.yaml --cloud-yaml .megaplan/initiatives/native-build-forward-continuation-20260902-r4/cloud.yaml`.
