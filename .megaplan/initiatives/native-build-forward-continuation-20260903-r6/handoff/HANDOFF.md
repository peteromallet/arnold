...
Canonical source is `main@ec8d04fefa80ff723246649486ee5169cc96e2b5`.
The intended branch is `fixer/native-build-forward-c2-4635fc27-20260903-r6`.
The cloud workspace, runtime candidate, and session all use the unique
namespace `native-build-forward-c2-4635fc27-20260903-r6`:

- runtime candidate: `/workspace/runtime-candidates/native-build-forward-c2-4635fc27-20260903-r6`
- chain session: `native-build-forward-c2-4635fc27-20260903-r6`
- supported marker directory: `/workspace/.megaplan/cloud-sessions`; expected marker filename: `native-build-forward-c2-4635fc27-20260903-r6.json`
- chain spec: `.megaplan/initiatives/native-build-forward-continuation-20260903-r6/chain.yaml`
...
under the r2 namespace; they are not deleted, imported, or replayed by r6.
...
immutable and are not reused by r6.
...
no r5 marker, chain state, owner, or provider receipt was created, and r6
...
2. verify that the chain driver's content-addressed revision pin
   (`ec8d04fefa80ff723246649486ee5169cc96e2b5`) and the remote checkout agree,
...
4. confirm the new chain has no persisted state and starts at C2, while the
   ...
   next action supported: `uv run python -m arnold_pipelines.megaplan cloud chain .megaplan/initiatives/native-build-forward-continuation-20260903-r6/chain.yaml --cloud-yaml .megaplan/initiatives/native-build-forward-continuation-20260903-r6/cloud.yaml`.
