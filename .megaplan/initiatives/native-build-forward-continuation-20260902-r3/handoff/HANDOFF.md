...
Canonical source is `main@f814d8fe660e9b96ab6d7eb4c3263eb94cc22ed6`.
The intended branch is `fixer/native-build-forward-c2-ec69ede3-20260902-r3`.
The cloud workspace, runtime candidate, and session all use the unique
namespace `native-build-forward-c2-ec69ede3-20260902-r3`:

- runtime candidate: `/workspace/runtime-candidates/native-build-forward-c2-ec69ede3-20260902-r3`
- chain session: `native-build-forward-c2-ec69ede3-20260902-r3`
- supported marker directory: `/workspace/.megaplan/cloud-sessions`; expected marker filename: `native-build-forward-c2-ec69ede3-20260902-r3.json`
- chain spec: `.megaplan/initiatives/native-build-forward-continuation-20260902-r3/chain.yaml`
...
under the r2 namespace; they are not deleted, imported, or replayed by r3.
...
2. verify that the chain driver's content-addressed revision pin
   (`f814d8fe660e9b96ab6d7eb4c3263eb94cc22ed6`) and the remote checkout agree,
...
4. confirm the new chain has no persisted state and starts at C2, while the
   ...
   next action supported: `uv run python -m arnold_pipelines.megaplan cloud chain .megaplan/initiatives/native-build-forward-continuation-20260902-r3/chain.yaml --cloud-yaml .megaplan/initiatives/native-build-forward-continuation-20260902-r3/cloud.yaml`.
