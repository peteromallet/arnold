...
Canonical source is `main@c7135595df3afb7685eae0a68a006438294b1198`.
The intended branch is `fixer/native-build-forward-c2-780129da-20260903-r5`.
The cloud workspace, runtime candidate, and session all use the unique
namespace `native-build-forward-c2-780129da-20260903-r5`:

- runtime candidate: `/workspace/runtime-candidates/native-build-forward-c2-780129da-20260903-r5`
- chain session: `native-build-forward-c2-780129da-20260903-r5`
- supported marker directory: `/workspace/.megaplan/cloud-sessions`; expected marker filename: `native-build-forward-c2-780129da-20260903-r5.json`
- chain spec: `.megaplan/initiatives/native-build-forward-continuation-20260903-r5/chain.yaml`
...
under the r2 namespace; they are not deleted, imported, or replayed by r5.
...
immutable and are not reused by r5.
...
2. verify that the chain driver's content-addressed revision pin
   (`c7135595df3afb7685eae0a68a006438294b1198`) and the remote checkout agree,
...
4. confirm the new chain has no persisted state and starts at C2, while the
   ...
   next action supported: `uv run python -m arnold_pipelines.megaplan cloud chain .megaplan/initiatives/native-build-forward-continuation-20260903-r5/chain.yaml --cloud-yaml .megaplan/initiatives/native-build-forward-continuation-20260903-r5/cloud.yaml`.
