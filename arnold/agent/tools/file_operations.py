...
Provides file manipulation capabilities (read, write, patch, search) over the
canonical local terminal environment.
...
Usage:
    ...
    from arnold.agent.tools.terminal_tool import _active_environments
...
class ShellFileOperations(FileOperations):
    ...
    Works with the canonical local terminal environment.
    """
    ...
    def __init__(self, terminal_env, cwd: str = None):
        ...
        self.cwd = cwd or getattr(terminal_env, 'cwd', None) or os.getcwd()
    ...
    def patch_replace(self, path: str, old_string: str, new_string: str,
        ...
        from arnold.agent.tools.fuzzy_match import fuzzy_find_and_replace
    ...
    def patch_v4a(self, patch_content: str) -> PatchResult:
        ...
        """
        # Import patch parser
        from arnold.agent.tools.patch_parser import parse_v4a_patch, apply_v4a_operations
