...
Usage:
    from arnold.agent.tools.skills_tool import skills_list, skill_view, check_skills_requirements
...
import yaml
from arnold.agent.hermes_cli.config import load_env, _ENV_VAR_NAME_RE
...
def _find_all_skills(*, skip_disabled: bool = False) -> List[Dict[str, Any]]:
    ...
    Args:
        skip_disabled: If True, return ALL skills regardless of disabled
            state (used by the CLI skills config UI). Default False
